...
// Full control access.
extern void ADS1x1x_write_register(uint8_t i2c_address, uint8_t reg, uint16_t value);
extern uint16_t ADS1x1x_read_register(uint8_t i2c_address, uint8_t reg);
